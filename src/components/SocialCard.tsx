...
const platformColors = {
  facebook: 'bg-[#1877f2]',
  instagram: 'bg-gradient-to-br from-[#405de6] via-[#e1306c] to-[#ffdc80]',
  tiktok: 'bg-black',
  youtube: 'bg-[#ff0000]'
};
...
const SocialCard = ({ platform, children, onDelete }: SocialCardProps) => {
  return (
    <div 
      className={`relative w-full h-full rounded-xl ${platformColors[platform]} text-white p-6 transition-all duration-300 ease-in-out cursor-pointer flex flex-col items-center justify-center gap-3 group`}
      onMouseDown={(e) => {
