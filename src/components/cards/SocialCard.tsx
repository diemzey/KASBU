...
type SocialPlatform = 'facebook' | 'instagram' | 'tiktok' | 'youtube' | 'twitter';
...
const platformConfig = {
  facebook: {
    ...
    defaultText: 'Sígueme en Facebook'
  },
  instagram: {
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    gradient: 'from-fuchsia-600 via-pink-600 to-orange-600',
    defaultText: 'Sígueme en Instagram'
  },
  tiktok: {
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
  ...
  youtube: {
    ...
    defaultText: 'Sígueme en YouTube'
  },
  twitter: {
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    defaultText: 'Sígueme en Twitter'
  }
};
